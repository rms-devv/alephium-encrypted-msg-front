...
import { MessageThread } from "./features/accountMessages/MessageThread"
...
const walletRoutes = (
  <>
    ...
    <Route
      presentation="push"
      path={routes.accountMessages.path}
      element={<AccountScreen tab="messages" />}
    />
    <Route
  presentation="push"
  path={routes.messageThread.path}
